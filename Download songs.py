...
for i, link in enumerate(ids, 1):
    ...
    os.system(f"{YT_DLP_LOCATION} -o \"{config[app_name]['download_path']}/{config[app_name]['title_format']}\" {config[app_name]['yt_dl_options']} https://www.youtube.com/watch?v={link}")